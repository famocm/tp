...
<body>
  ...
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    ...
    <!--  <div id="DataTables_Table_1_length" class="dataTables_length">
     ...
     <form action="/test/index.php/Admin/User/index" method="get">
     <div class="dataTables_filter" id="DataTables_Table_1_filter" style="text-align:center;">
      <label>搜索: <input aria-controls="DataTables_Table_1" type="text"  name="username" value="<?php echo ($_GET['username']); ?>" placeholder="用户名" /></label>
     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
        <?php if(is_array($list)): foreach($list as $key=>$row): ?><tr class="odd"> 
            ...
            <td class="status"><?php if($row["status"] == '0'): ?>待激活<?php endif; if($row["status"] == '1'): ?>普通用户<?php endif; if($row["status"] == '2'): ?>会员<?php endif; ?></td> 
            <td class=""><?php echo (date("Y-m-d",$row['addtime'])); ?></td> 
            <td class=" "><a href="/test/index.php/Admin/User/delete/id/<?php echo ($row['id']); ?>" class="btn btn-success"><i class="icon-trash"></i></a> <a href="/test/index.php/Admin/User/edit/id/<?php echo ($row['id']); ?>" class="btn btn-info"><i class="icon-wrench"></i></a></td> 
 ...
 $(".del").click(function(){
  ...
  if(s){  
      //Ajax
      $.get("/test/index.php/Admin/User/del",{uname:a},function(data){
        if(data==1){
          // 清除选中的html样式
  ...
  //获取用户td 绑定双击事件
    $(".username").dblclick(function(){
      ...
      input.blur(function(){
        ...
        //Ajax
        $.post("/test/index.php/Admin/User/ajaxname",{id:id,usernames:newname},function(data){
            alert(data);
    ...
    $(".email").dblclick(function(){
      ...
      input.blur(function(){
        ...
        //Ajax
        $.post("/test/index.php/Admin/User/ajaxemail",{id:id,email:newemail},function(data){
            alert(data);
