 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/index.php/admin/root/update" method="post"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">用户名</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="username" value="<?php echo ($info['username']); ?>"/> 
       </div> 
      </div> 
      ...
      <div class="mws-form-row"> 
       <label class="mws-form-label">状态</label> 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="status" type="radio" value="2" <?php if($info["status"] == 2): ?>checked<?php endif; ?>/>管理员&nbsp;&nbsp;&nbsp;&nbsp;
        <input name="status" type="radio" value="3" <?php if($info["status"] == 3): ?>checked<?php endif; ?> />超级管理员
      </div> 
