 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/index.php/Admin/Advert/update" method="post" enctype="multipart/form-data"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">旧图片</label> 
       <div class="mws-form-item"> 
        <img src="/Public/Adverts/t_<?php echo ($info['picname']); ?>" alt=""> 
       </div> 
      </div>
      <div class="mws-form-row"> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="large" type="text" name="describe" value="<?php echo ($info['describe']); ?>"/> 
       </div> 
      </div>
       <div class="mws-form-row"> 
         <label class="mws-form-label">状态</label> 
         <div class="mws-form-item"> 
          <!-- <input class="large" type="text" name="status" value="<?php echo ($info['status']); ?>"/>  -->
          <ul class="mws-form-list inline">
            <li><input name="status" type="radio" value="1" <?php if($info['status'] == 1): ?>checked<?php endif; ?>> <label>显示</label></li>
            <li><input name="status" type="radio" value='2' <?php if($info['status'] == 2): ?>checked<?php endif; ?>> <label>不显示</label></li>
     ...
     <div class="mws-button-row" style="text-align:center;"> 
      ...
      <input type="hidden" name="oldname" value="<?php echo ($info['picname']); ?>">
