...
<body>
	...
	<html>
 <head></head>
<script type="text/javascript" charset="utf-8" src="/Public/Admins/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/Public/Admins/ueditor.all.min.js"> </script>
<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
<script type="text/javascript" charset="utf-8" src="/Public/Admins/lang/zh-cn/zh-cn.js"></script>
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/index.php/admin/good/update" method="post" enctype="multipart/form-data"> 
     <div class="mws-form-inline">
     <!--  <div class="mws-form-row">
      <label class="mws-form-label">商品类别</label>
      <div class="mws-form-item">
          <select class="large">
              <option value="<?php echo ($info['typeid']); ?>" selected><?php echo ($info['cname']); ?></option>
          </select>
          </div>
      </div>  -->
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="large" type="text" name="goods" value="<?php echo ($info['goods']); ?>"/> 
       </div> 
      </div>
		<div class="mws-form-row">
			<label class="mws-form-label">简介</label>
			<div class="mws-form-item"> 
        <input class="large" type="text" name="descr" value="<?php echo ($info['descr']); ?>"/> 
       </div>
		</div>
    <div class="mws-form-row"> 
       ...
       <div class="mws-form-row"> 
       <label class="mws-form-label">促销价</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="cprice" value="<?php echo ($info['cprice']); ?>"/> 
       </div> 
      </div>
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="large" type="text" name="size" value="<?php echo ($info['size']); ?>"/> 
       </div>  
      </div>
      <div class="mws-form-row"> 
       <label class="mws-form-label">颜色</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="color" value="<?php echo ($info['color']); ?>"/> 
       </div> 
      </div>
      <div class="mws-form-row"> 
       <label class="mws-form-label">库存</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="store" value="<?php echo ($info['store']); ?>"/> 
       </div> 
      </div>
      <div class="mws-form-row"> 
       <label class="mws-form-label">图片</label> 
       <div class="mws-form-item"> 
        <img width="50px" height="50px" src="<?php echo ($info['picname']); ?>" alt="">
       </div> 
      </div> 
       <div class="mws-form-row"> 
       <label class="mws-form-label">上传图片</label> 
       <div class="mws-form-item"> 
        <input class="large" type="file" name="picname"/> 
       </div> 
      </div>
      <div class="mws-form-row">
      ...
      <div class="mws-form-item clearfix">
        <ul class="mws-form-list inline">
          <li><input name="status" type="radio" value="1" <?php if($info['status'] == 1): ?>checked<?php endif; ?>> <label>新添加</label></li>
          <li><input name="status" type="radio" value='2' <?php if($info['status'] == 2): ?>checked<?php endif; ?>> <label>在售</label></li>
          <li><input name="status" type="radio" value="3" <?php if($info['status'] == 3): ?>checked<?php endif; ?>> <label>下架</label></li>
        </ul>
      </div>
    </div>
