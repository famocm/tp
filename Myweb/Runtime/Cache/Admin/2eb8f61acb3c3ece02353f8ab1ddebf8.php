 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/index.php/Admin/Article/update" method="post"> 
     <div class="mws-form-inline"> 

       <div class="mws-form-row"> 
       <label class="mws-form-label">回复买家:</label> 
       <div class="mws-form-item"> 
          <!-- <input type="type" name="descr"> -->
          <textarea name="reply" id="" cols="30" rows="10"><?php echo ($info['descr']); ?></textarea>
        	<!-- <script id="editor" type="text/plain" name="descr" style="width:600px;height:400px;"><?php echo ($info['descr']); ?></script> -->
       </div> 
      </div> 
