 ...
 <body>
  <div class="mws-panel grid_8"> 
   <div class="mws-panel-header"> 
    <span><i class="icon-table"></i> 商品类别</span> 
   </div> 
   <div class="mws-panel-body no-padding"> 
    ...
    <!--  <div id="DataTables_Table_1_length" class="dataTables_length">
     ...
     <form action="/test/index.php/Admin/Cate/index" method="get">
     <div class="dataTables_filter" id="DataTables_Table_1_filter">
      <label>类名搜索: <input aria-controls="DataTables_Table_1" type="text"  name="name" value="<?php echo ($_GET['name']); ?>"/></label>
     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
        <?php if(is_array($list)): foreach($list as $key=>$row): ?><tr class="odd"> 
            ...
            <td class=" "><a href="/test/index.php/Admin/Cate/delete/id/<?php echo ($row['id']); ?>" class="btn btn-success"><i class="icon-trash"></i></a> <a href="/test/index.php/Admin/Cate/edit/id/<?php echo ($row['id']); ?>" class="btn btn-info"><i class="icon-wrench"></i></a></td> 
