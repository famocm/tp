...
<body>
	...
	<html>
		<head>
			<script src="/test/Public/Admins/js/echarts.js"></script>
		</head>
		<body>
			<div id="main" style="width:1000px;height:500px;margin:10px;margin-left:20px;"></div>
			<script>
		        ...
		        var option = {
		            ...
		            xAxis: {
		                data: ["内衣","鞋子","裤子","家用电器","女装","男装","手机","水果","蔬菜","肉类","零食"]
		            },
		            yAxis: {},
		            series: [{
		                name: '销量',
		                type: 'bar',
		                data: [5,20,36,10,10,20,20,30,40,50,80]
		            }]
		        };
   ...
   <!-- <img src="/test/Public/Admins/b/images/01.jpg" alt="" style="margin-left:300px;margin-top:100px;"> -->
