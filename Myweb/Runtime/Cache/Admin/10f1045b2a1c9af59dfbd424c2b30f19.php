...
<body>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   <div class="mws-panel-header"> 
    <span><i class="icon-table"></i> 管理员列表页</span> 
   </div> 
   <div class="mws-panel-body no-padding"> 
    ...
    <!--  <div id="DataTables_Table_1_length" class="dataTables_length">
     ...
     <!-- <form action="/index.php/Admin/Root/index" method="get">
     ...
     <div class="dataTables_paginate paging_full_numbers " id="DataTables_Table_1_paginate">
        <?php if(is_array($pp)): foreach($pp as $key=>$value): ?><a href="javascript:void(0)" onclick="page(<?php echo ($value); ?>)" style="width:30px;height:30px;line-height:30px;text-align:center;border:1px solid #ccc;display:block;float:left"><?php echo ($value); ?></a><?php endforeach; endif; ?>
     </div>
    </div> 
   </div> 
  </div>
 ...
 <script type="text/javascript">
  ...
  function page(page){
    //Ajax
    $.get('/index.php/Admin/Root/index',{page:page},function(data){
      // alert(data);
      //把接收到的响应数据赋值给div 文本值
      $("#uid").html(data);
    });
