 ...
 <body>
  <div class="mws-panel grid_8"> 
   <div class="mws-panel-header"> 
    <span><i class="icon-table"></i> 节点管理列表页</span> 
   </div> 
   <div class="mws-panel-body no-padding"> 
    ...
    <!--  <div id="DataTables_Table_1_length" class="dataTables_length">
     ...
     <!-- <form action="/index.php/Admin/Node/index" method="get">
     <div class="dataTables_filter" id="DataTables_Table_1_filter" style="text-align:center;">
      <label>搜索: <input aria-controls="DataTables_Table_1" type="text"  name="username" value="<?php echo ($_GET['username']); ?>"/></label>
     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      <thead> 
       <tr role="row">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 208px;" aria-label="Browser: activate to sort column ascending">节点名</th>
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 208px;" aria-label="Browser: activate to sort column ascending">控制器名</th>
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 208px;" aria-label="Browser: activate to sort column ascending">方法名</th>
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
        <?php if(is_array($list)): foreach($list as $key=>$row): ?><tr class="odd"> 
            ...
            <td class=" "><?php echo ($row['function']); ?></td> 
            <td class=" "><a href="/index.php/Admin/Node/delete/id/<?php echo ($row['id']); ?>" class="btn btn-success"><i class="icon-trash"></i><a href="/index.php/Admin/Node/edit/id/<?php echo ($row['id']); ?>" class="btn btn-info"><i class="icon-wrench"></i></a></td> 
