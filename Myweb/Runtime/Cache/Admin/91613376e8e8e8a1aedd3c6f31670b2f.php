 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/index.php/Admin/Order/update" method="post"> 
     <div class="mws-form-inline"> 
     <!--  <div class="mws-form-row"> 
       <label class="mws-form-label">收货地址</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="address" value="<?php echo ($info['address']); ?>"/> 
       </div> 
      </div>  -->
       ...
       <div class="mws-form-item"> 
       <!--  <input class="large" type="text" name="status" value="<?php if($info["status"] == "1"): ?>新添加<?php endif; if($info["status"] == "2"): ?>已发货<?php endif; if($info["status"] == "3"): ?>已收货<?php endif; ?>"/>  -->
            <!-- <?php if($info["status"] == '1'): ?>新订单<?php endif; ?> -->
            <!-- <?php echo ($info['status']?$info['msg']:$info['error']); ?> -->
           <input type="radio" name="status" value="1" <?php if($info['status'] == 1): ?>checked<?php endif; ?> <?php echo ($info['status']>1?'disabled':''); ?>>新订单&nbsp;&nbsp;&nbsp;
           <input type="radio" name="status" value="2" <?php if($info['status'] == 2): ?>checked<?php endif; echo ($info['status']>2?'disabled':''); ?>>已发货&nbsp;&nbsp;&nbsp;
           <!-- <input type="radio" name="status" value="3" <?php if($info['status'] == 3): ?>checked<?php endif; echo ($info['status']>3?'disabled':''); ?>>已收货&nbsp;&nbsp;&nbsp; -->
           <!-- <input type="radio" name="status" value="4" <?php if($info['status'] == 4): ?>checked<?php endif; echo ($info['status']>4?'disabled':''); ?>>无效订单 -->
       </div> 
      </div> 
      ...
      <!--  <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="large" type="text" name="sname" value="<?php echo ($info['sname']); ?>"/> 
       </div> 
      </div> 
        -->
    <!--   <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="large" type="text" name="phone" value="<?php echo ($info['phone']); ?>"/> 
       </div> 
      </div>  -->
