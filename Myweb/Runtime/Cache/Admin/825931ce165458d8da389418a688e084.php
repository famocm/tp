 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/index.php/admin/cate/update" method="post"> 
    ...
    <!-- <div class="mws-form-item"> -->
      <!-- <select class="large" name="pid"> -->
        ...
        <!-- <?php if(is_array($list)): foreach($list as $key=>$row): ?>-->
          <!-- <option value="<?php echo ($row['id']); ?>" <?php if($info['pid'] == $row['id']): ?>selected<?php endif; ?>><?php echo ($row['name']); ?></option> -->
