...
<body>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <h1>当前<?php echo ($roots['username']); ?>的角色信息</h1> 
    <form class="mws-form" action="/index.php/admin/Role/rolelist" method="post"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label"></label>
       <?php if(is_array($rolelist)): foreach($rolelist as $key=>$vo): ?><div class="mws-form-item"> 
        <input class="large" type="checkbox" <?php if(in_array($vo['id'],$rids)): ?>checked<?php endif; ?> value="<?php echo ($vo['id']); ?>" name="rid[]" /><?php echo ($vo['name']); ?>
        <input type="hidden" name="uid" value="<?php echo ($roots['id']); ?>">
