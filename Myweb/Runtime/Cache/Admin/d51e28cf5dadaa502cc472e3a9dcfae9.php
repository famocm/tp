 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/index.php/Admin/Lunbo/update" method="post" enctype="multipart/form-data"> 
     <div class="mws-form-inline"> 
      ...
      <div class="mws-form-row"> 
          ...
          <div class="mws-form-item"> 
         <img src="/Public/Uploads/<?php echo ($info['img']); ?>" width="100px" height="100px">
         </div> 
      </div>
      <div class="mws-form-row"> 
       <label class="mws-form-label">上传新图</label> 
       <div class="mws-form-item"> 
        <input class="large" type="file" name="img" /> 
       </div> 
      </div>
     ...
     <div class="mws-button-row"> 
      ...
      <input type="hidden" value="<?php echo ($info['img']); ?>" name="oldimg">
