...
<body>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <h1><?php echo ($roles['name']); ?>的权限信息</h1> 
    <form class="mws-form" action="/index.php/Admin/Node/nodelist" method="post"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label"></label>
       <?php if(is_array($nodelist)): foreach($nodelist as $key=>$vo): ?><div class="mws-form-item"> 
        <input class="large"  type="checkbox" <?php if(in_array($vo['id'],$pids)): ?>checked<?php endif; ?> value="<?php echo ($vo['id']); ?>" name="pid[]" /><?php echo ($vo['name']); ?>
        <input type="hidden" name="rid" value="<?php echo ($roles['id']); ?>">
