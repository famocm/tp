...
<html>
	...
	<head>
		...
		<link href="/Public/Homes/css/appstyle.css" rel="stylesheet" type="text/css">
		<script type="text/javascript" src="/Public/Homes/js/jquery-1.7.2.min.js"></script>
			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-comment">
						...
						<form action="/index.php/Home/Personal/docommentlist" method="post">
							<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?><div class="comment-list">
								<div class="item-pic">
									<a href="#" class="J_MakePoint">
										<img src="<?php echo ($good['picname']); ?>" class="itempic">
									</a>
								</div>
								...
								<div class="item-title">
									...
									<div class="item-name">
										<a href="#">
											<p class="item-basic-info"><?php echo ($good['name']); ?></p>
										</a>
									</div>
									<div class="item-info">
										<div class="info-little">
											<span>颜色：<?php echo ($good['color']); ?></span>
											<span>大小：<?php echo ($good['size']); ?></span>
										</div>
										<div class="item-price">
											<!-- 价格：￥<strong><?php echo ($good['total']/$good['num']); ?></strong> -->
										</div>										
									</div>
								</div>
								<div class="clear"></div>
								...
								<!-- <div class="filePic">
									...
									<span>晒照片(0/5)</span>
									<img src="/Public/Homes/images/image.jpg" alt="">
								</div> -->
								<!-- <div class="item-opinion">
									<li><i class="op1"></i>好评:<input type="radio" name="op<?php echo ($good['id']); ?>[]" value="1"></li>
									<li><i class="op2"></i>中评:<input type="radio" name="op<?php echo ($good['id']); ?>[]" value="2"></li>
									<li><i class="op3"></i>差评:<input type="radio" name="op<?php echo ($good['id']); ?>[]" value="3"></li>
								</div> -->
								<!-- <input type="hidden" value=<?php echo ($good['goods_id']); ?> name="goods_id"> -->
								<!-- <input type="hidden" value=<?php echo ($good['id']); ?> name="orders_id[]"> -->
								<input type="hidden" value=<?php echo ($good['goods_id']); ?> name="goods_id[]">
								<input type="hidden" value=<?php echo ($good['order_code']); ?> name="order_code">

								
							</div><?php endforeach; endif; else: echo "" ;endif; ?>
							<input type="submit" value="发表评论" style="margin-left:400px;">
							<!-- <div style="width:100px;"><input type="submit" value="发表评论"></div> -->
							</form>
							<!--多个商品评论-->
							<!-- <div class="comment-list">
								<div class="item-pic">
									<a href="#" class="J_MakePoint">
										<img src="/Public/Homes/images/comment.jpg_400x400.jpg" class="itempic">
									</a>
								</div>
