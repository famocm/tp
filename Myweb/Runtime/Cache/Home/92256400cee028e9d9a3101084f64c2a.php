...
<html>
	...
	<head>
		...
		<link href="/Public/Homes/css/stepstyle.css" rel="stylesheet" type="text/css">
		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
					...
					<form class="am-form am-form-horizontal" action="/index.php/home/Personal/dobindphone" method="post">
						<div class="am-form-group bind">
							<label for="user-phone" class="am-form-label">验证手机</label>
							<div class="am-form-content">
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$phone): $mod = ($i % 2 );++$i;?><span id="user-phone"><?php echo ($phone['phone']); ?></span><?php endforeach; endif; else: echo "" ;endif; ?>
							</div>
						</div>
    ...
    document.getElementById("sendMobileCode").onclick=function(){
        ...
        // alert(phone);
        $.post("/index.php/home/personal/checkphone",{phone:phone},function(data){
            alert(data);
        })
    }
    ...
    $("input[name='pcode']").blur(function(){
        var pcode=$(this).val();
        $.post('/index.php/home/personal/checkpcode',{pcode:pcode},function(data){
            if(data==1){
                PCODE=true;
            }else{
