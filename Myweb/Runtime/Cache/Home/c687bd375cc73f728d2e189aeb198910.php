      ...
      <div class="am-modal am-modal-no-btn" style="background-color: red"  id="doc-modal-1"> 
       <div class="add-dress"> 
        ...
        <div class="am-u-md-12 am-u-lg-8"  style="margin-top: 20px;">
         <form action="/index.php/home/Personal/update" method="post" class="am-form am-form-horizontal"> 
          <div class="am-form-group"> 
           <label for="user-name" class="am-form-label">收货人</label> 
           <div class="am-form-content"> 
            <input type="text" name="name" value="<?php echo ($list['name']); ?>"  placeholder="收货人" /><span></span>
           </div> 
          </div> 
          <div class="am-form-group"> 
           <label for="user-phone"  class="am-form-label">手机号码</label> 
           <div class="am-form-content"> 
            <input name="phone" value="<?php echo ($list['phone']); ?>"  placeholder="手机号必填" type="text" /><span></span> 
           </div> 
          </div> 
          <div class="am-form-group"> 
           <label for="user-phone"  class="am-form-label">邮编</label> 
           <div class="am-form-content"> 
            <input id="user-phone" value="<?php echo ($list['code']); ?>" name="code"  type="text" /> <span></span>
           </div> 
          </div> 
          <div class="am-form-group"> 
          ...
          <div class="am-form-group"> 
           ...
           <div class="am-form-content"> 
            <textarea class="" name="street" rows="3" id="user-intro" placeholder="输入详细地址"><?php echo ($list['street']); ?></textarea> 
