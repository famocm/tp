...
<html>
	...
	<head>
		...
		<link href="/Public/Homes/css/colstyle.css" rel="stylesheet" type="text/css">
				...
				<div class="main-wrap">
					...
					<div class="user-collection">
						...
						<div class="you-like">
							...
							<div class="s-content">
							<?php if(is_array($list)): foreach($list as $key=>$row): ?><div class="s-item-wrap">
									<div class="s-item">

										<div class="s-pic">
											<a href="#" class="s-pic-link">
												<img src="<?php echo ($row['picname']); ?>" alt="包邮s925纯银项链女吊坠短款锁骨链颈链日韩猫咪银饰简约夏配饰" title="包邮s925纯银项链女吊坠短款锁骨链颈链日韩猫咪银饰简约夏配饰" class="s-pic-img s-guess-item-img">
											</a>
										</div>
										<div class="s-info">
											<div class="s-title"><a href="#" title="包邮s925纯银项链女吊坠短款锁骨链颈链日韩猫咪银饰简约夏配饰"><?php echo ($row['goods']); ?></a></div>
											<div class="s-price-box">
												<span class="s-price"><em class="s-price-sign">¥</em><em class="s-value"><?php echo ($row['price']); ?></em></span>
										...
										<div class="s-tp">
											<span class="ui-btn-loading-before"><a href="/index.php/Home/Favorite/off?id=<?php echo ($row['id']); ?>" >取消收藏</a></span>
											<!-- <i class="am-icon-shopping-cart"></i> -->
											<!-- <span class="ui-btn-loading-before buy"><a href="/index.php/Home/Favorite/add?goods=<?php echo ($row['goods']); ?>" >加入购物车</a></span> -->
											<!-- <p>
